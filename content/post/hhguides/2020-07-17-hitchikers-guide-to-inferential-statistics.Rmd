...
- <u>Type II error</u> - probability of not saying the null hypothesis is wrong, even though it is wrong. Note, you're not actually saying it's true, just that it's not wrong.
