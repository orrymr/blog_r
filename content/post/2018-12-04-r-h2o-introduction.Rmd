...
# 1. Introduction
In this post we discuss the [H2O machine learning platform.](https://www.h2o.ai/) We talk about what H2O is, and how to get started with it, using R.
...
__H2O can be run on a cluster.__ H2O works on clusters such as [Hadoop](https://hadoop.apache.org/). I've yet to experiment with this, so, for now, I'll interpret "distributed, scalable machine learning" as saying that we can run the H2O platform on a cluster.
...
And the key-value part of DKV means that when you load data into H2O, you get back a key into a hashmap containing your (potentially distributed) object.
