...
XGBoost is ....
I will use this post to consolidate my learnings thus far about XGBoost.

# 2. Load And Explore The Data

We will use the [Titanic Dataset](https://www.kaggle.com/c/titanic/data) which comes prepackaged with the xgboost library. Basically, we try predict whether a passenger survived or not (so this is a binary classification problem).
